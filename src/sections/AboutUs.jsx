...
function AboutUs() {
  return (
    <div className=" container-wrapper  px-4 ">
      ...
      <div className="flex flex-col justify-center items-center big-info__inner px-4 border-[#a1ff3c] border ">
        <div className="flex flex-col justify-center items-center gap-4">
          ...
          <p className="text-lg font-medium text-[white] text-center p-2">
              By Buying CatHat, you become a part of the community. You're not just a fan, <br />you're a support
